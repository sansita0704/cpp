...
int main()
{
    ...
    // Buffer = [ 20]
    // Now, it will display the next message and now since the buffer is not empty the program will not wait for the user to enter any value.
    ...
    // But if the user enters more than 10 characters after the blank space then again same problem will occur.
