...
int main()
{
    ...
    // Go to 'Part 3: Advanced/3. Inheritance and Polymorphism/Widget.h' and 'Part 3: Advanced/3. Inheritance and Polymorphism/TextBox.h' to see how we have overriden draw().
